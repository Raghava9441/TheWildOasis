        ...
        <StyledSalesChart>
            ...
            <ResponsiveContainer height={300} width="100%">
                <AreaChart data={data}>
                    ...
                    <Area dataKey='totalSales' type="monotone" stoke={colors.totalSales.stroke} fill={colors.totalSales.fill} stroke={2} name="Total Sales" unit="$" />
                    <Area dataKey='extrasSales' type="monotone" stoke={colors.extrasSales.stroke} fill={colors.extrasSales.fill} stroke={2} name="Extra Sales" unit="$" />
                </AreaChart>
            </ResponsiveContainer>
        </StyledSalesChart>
    )
